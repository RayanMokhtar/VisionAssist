...
from langage.api.schemas.chat import ChatRequest, ChatResponse
from langage.api.services.agent import agent_service
...
async def chat(request: ChatRequest) -> ChatResponse:
    ...
    try:
        ...
        broker_resp = agent_service.handle(broker_req)
        response_text = broker_resp.response or ""
